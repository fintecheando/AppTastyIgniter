...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://foodkart-d3aea.firebaseio.com/"),
    refCart = new Firebase("https://foodkart-d3aea.firebaseio.com/cart"),
    refUser = new Firebase("https://foodkart-d3aea.firebaseio.com/users"),
    refCategory = new Firebase("https://foodkart-d3aea.firebaseio.com/category"),
    refOrder = new Firebase("https://foodkart-d3aea.firebaseio.com/orders"),
    refFeatured = new Firebase("https://foodkart-d3aea.firebaseio.com/featured"),
    refMenu = new Firebase("https://foodkart-d3aea.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
